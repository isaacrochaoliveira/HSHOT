            ...
            for ($i = 0; $i < count($res); $i++) {
                ...
                <tr>
                    <td>
                        ...
                        <a href="#" title="Destacar Versículo" class="text-warning f-20" data-bs-toggle="modal" data-bs-target="#ModalDestacarVers" onclick="document.getElementById('id_PL').value = '<?php echo $id_pl; ?>'; document.getElementById('livroReadOnlyDesc').value = '<?php echo $nome_l; ?>'"><i class="fa-solid fa-highlighter"></i></a>
                    </td>
